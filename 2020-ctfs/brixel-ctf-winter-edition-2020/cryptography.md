...
![derfl agist sauer kraut](<../../.gitbook/assets/image (114).png>)
...
![Kali Linux VM with 2GB memory](<../../.gitbook/assets/image (275).png>)

After increasing the memory on my VM, the password is easily cracked in 1 second!

![Kali Linux VM with 8GB memory](<../../.gitbook/assets/image (186).png>)
