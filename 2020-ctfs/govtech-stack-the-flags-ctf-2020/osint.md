...
![On line 858, we can see the comment Will fork to our gitlab - @joshhky](<../../.gitbook/assets/image (222).png>)

![logged in to gitlab and searched for the user @joshhky and found the user Josh Hong.](<../../.gitbook/assets/image (244).png>)
...
{% file src="../../.gitbook/assets/osint-challenge-7.mp4" %}

The audio sounds like airplane sound and the video looks like its near park. Hence, after some searching on Google Maps, I concluded its near paya lebar air base at punggol park. The flag is postal code of punggol park.
...
In this challenge, we were given 3 video files in a zip.

{% file src="../../.gitbook/assets/osint-challenge-2.zip" %}
...
![This image looked like the one we saw in the second video.](<../../.gitbook/assets/image (46).png>)

![Found this image which looked like the image in third video. This is at Blk 870.](<../../.gitbook/assets/image (182).png>)
