...
![Flag part1: govtech-csg{dump](<../../.gitbook/assets/image (255).png>)

![Flag part2: ster\_diving](<../../.gitbook/assets/image (105).png>)

![Flag part3: \_is\_impre](<../../.gitbook/assets/image (208).png>)

![Flag part4: ssive}](<../../.gitbook/assets/image (247).png>)
...
![This does not look anything like a flag to me.](<../../.gitbook/assets/image (245).png>)
...
![Here we get the message that the flag is hidden in a file](<../../.gitbook/assets/image (258).png>)

2\. Show .b, hide .a and .c

![Now we can tell that the flag is hidden in CSG.TXT file](<../../.gitbook/assets/image (207).png>)

3\. Go to the /CSG.TXT path by adding /CSG.TXT to the end of the web address&#x20;

![encoded in base 64 format](<../../.gitbook/assets/image (206).png>)

4\. Decode the base 64 string on [here ](https://cryptii.com/)

![Get output : Fj4c\_Gu3\_fGlY3\_i1f1o1Y1Gl](<../../.gitbook/assets/image (86).png>)
