...
![Cracked password: will](<.gitbook/assets/image (434).png>)
...
![Cracked password: time](<.gitbook/assets/image (513).png>)
...
![Right side shows fixed file signature](<.gitbook/assets/image (198).png>)
