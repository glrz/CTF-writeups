...
Based on previous CTF experience, and the description mentioned `64`, this can be easily recognised as Base64 encoded message.&#x20;
...
![derfl agist sauer kraut](<../.gitbook/assets/image (164).png>)
...
![Kali Linux VM with 2GB memory](<../.gitbook/assets/image (84).png>)

After increasing the memory on my VM, the password is easily cracked in 1 second!

![Kali Linux VM with 8GB memory](<../.gitbook/assets/image (168).png>)
