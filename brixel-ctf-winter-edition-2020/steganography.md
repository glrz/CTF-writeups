...
In this challenge, using the `binwalk` we can see that there are hidden files in this word document.
...
![flag.txt file inside](<../.gitbook/assets/image (186).png>)
...
If we play the audio, we recognise its an audio of [Darude sandstorm](https://www.youtube.com/watch?v=y6120QOlsfU), nothing out of the ordinary.
...
![the flag is: chucktesta](<../.gitbook/assets/image (206).png>)
