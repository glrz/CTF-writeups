...
![This is not it man, try harder!](<.gitbook/assets/image (334).png>)

Brainfuck output:

![This is it? nah](<.gitbook/assets/image (283).png>)

Pikalang output:

![lol no](<.gitbook/assets/image (277).png>)

Base32 output:

![This is not the flag man D:](<.gitbook/assets/image (111).png>)

ROT13 output:

![flag{notThatSimple:P}](<.gitbook/assets/image (143).png>)
